...
const i18n = {
  en: {
    ...
    showOnlyFirst: "Show First only (hide Not First)",
    showOnlyDup: "Show Not First only",
    hideNonSameNameFirst: "Hide non-duplicate groups",
  ...
  zh: {
    ...
    showOnlyFirst: "只显示首发（隐藏非首发）",
    showOnlyDup: "只显示非首发",
    hideNonSameNameFirst: "隐藏非同名组",
